package com.tlglearning.fizzbuzz.model;       //Testing Fizz, Buzz, FizzBuzz, and None
...
class AnalysisTest {
  ...
  static final Set<State> buzzExpected = EnumSet.of(State.FIZZ);
  static final Set<State> fizzBuzzExpected = EnumSet.of(State.FIZZ);
  static final Set<State> neitherExpected = EnumSet.of(State.FIZZ);
