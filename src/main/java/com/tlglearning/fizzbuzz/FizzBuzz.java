  ...
  public static void main(String[] args) {
    try {
      ...
      for (int counter = 1; counter <= upperBound; counter++) {
        ...
        System.out.println(result.isEmpty() ? counter : result);     //Ternary Operator based on if-else statement
      }
    } catch (IllegalArgumentException e) {                     //Zero or more catch clauses
